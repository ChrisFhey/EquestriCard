...
public class CardDetailActivity extends AppCompatActivity implements AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View cardImage = findViewById(R.id.cardImage);
        cardImage.setOnClickListener(new View.OnClickListener(){
           public void onClick(View view) {
               zoomImageFromThumb(cardImage, R.drawable.premiere_001);
           }
        });
    ...
    private void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        expandedImageView.setPivotX(-8f);
        expandedImageView.setPivotY(-20f);
